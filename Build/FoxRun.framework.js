...
function _GetLocalStorageItems() {
 ...
 console.log("LocalStorage items list: ", items);
 window["DevGame"].SendMessage("HandleWebCall", "HandleData", JSON.stringify(items));
}
...
function _WebGLInputCreate(canvasId, x, y, width, height, fontsize, text, placeholder, isMultiLine, isPassword, isHidden, isMobile, isInputNumber) {
...
var asmLibraryArg = {
 "GetLocalStorageItems": _GetLocalStorageItems,
